...
SOURCES = main.cpp hash_table.cpp hash_func.cpp hash_table_statistics.cpp input.cpp test.cpp my_strcmp.cpp list/list.cpp Include_file/utilities/utils.cpp Include_file/error/error.cpp
