...
Для заполнения хеш-таблицы был взят текст "Евгения Онегина" на английском языке, из которого были удалены все знаки препинания и который был разбит на отдельные слова. Всего слов было `14379`, уникальных из них `34307`.
...
|---------------------------------------------------------|--------------------------------|-------------------------|
| Константа(ноль)                                         | 103274                         |                         |
| Частное контрольной суммы и длины слова                 | 22860                          |                         |
| Длина слова                                             | 15764                          |                         |
| ASCII код первой буквы слова                            | 4060                           |                         |
| Контрольная сумма                                       | 544                            |                         |
| Rotate right                                            | 71                             |                         |
| Rotate left                                             | 20                             |                         |
