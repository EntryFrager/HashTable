...
1. Исследовать заселенность хеш-таблицы для определенного набора хеш-функций и выбрать лучшую
...
> [!NOTE]
>
> Более подробно с кодом ds можете ознакомиться [здесь](https://godbolt.org/z/r6qYdKe8f).
